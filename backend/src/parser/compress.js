...
// Hit the wire safely under Anthropic's cap. Base64 expands by ~33%; a 4MB
// buffer is ~5.4MB on the wire — but Anthropic measures the DECODED bytes,
// so 4MB decoded is what matters.
const COMPRESS_THRESHOLD = Math.floor(ANTHROPIC_MAX_BYTES * 0.85); // ~4.46 MB
